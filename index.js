...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.jnu0u.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        app.put('/invenrotyitems/:id', async (req, res) => {
            ...
            const updatedResult = await inventoryItemsCollections.updateOne(filter, updatedDoc, options);
        ...
        // my items
        app.get('/invenrotyitemsQ', verifyJWT, async (req, res) => {
